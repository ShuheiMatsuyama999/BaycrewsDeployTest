...
(function($){
    ...
    $.extend({
    	...
    	successCallbackForHeader: function() {
    		//Ajax通信成功
    		initAllHeaderUnit();
    		$("#date_info .day").css("display","block");
    		$("#date_info .temperature").css("display","block");
    		$("#ajaxTemperature span").css("display","block");
    		$("#date_info #list_weather li").css("display","block");
    	},
